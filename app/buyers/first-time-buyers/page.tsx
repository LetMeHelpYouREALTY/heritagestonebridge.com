      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="First-Time Buyer Financing Options" />
          ...
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Best Neighborhoods for First-Time Buyers" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="mb-16 bg-green-600 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="flex items-center justify-center mb-6">
              ...
              <SectionImage heading="New Construction Incentives" />
          ...
          {/* Rent vs Buy */}
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="Rent vs. Buy in Las Vegas" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="First-Time Buyer Timeline" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          {/* FAQ Section */}
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="First-Time Buyer FAQs" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Ready to Stop Renting?" />
