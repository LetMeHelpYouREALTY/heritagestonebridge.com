      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto mb-16">
            ...
            <div className="bg-white border border-slate-200 rounded-lg overflow-hidden">
              <div className="bg-blue-600 text-white p-4 text-center">
                <SectionImage heading="Schedule Your Free Valuation" />
            ...
            <div className="space-y-8">
              <div className="bg-slate-900 text-white rounded-lg p-8">
                <SectionImage heading="Why Request a BHHS Valuation?" />
          ...
          <section className="max-w-5xl mx-auto mb-16">
            <SectionImage heading="Why Online Home Value Estimates Often Miss the Mark" />
          ...
          <section className="max-w-5xl mx-auto mb-16 bg-slate-50 rounded-2xl p-8 md:p-12">
            <SectionImage heading="Key Factors That Affect Your Las Vegas Home's Value" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          {/* Neighborhood Values */}
          <section className="max-w-5xl mx-auto mb-16">
            <SectionImage heading="Las Vegas Neighborhood Home Values | January 2026" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="max-w-5xl mx-auto mb-16">
            <SectionImage heading="The BHHS Home Valuation Process" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="max-w-4xl mx-auto mb-16">
            <SectionImage heading="Frequently Asked Questions About Home Valuations" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Ready to Know What Your Home Is Worth?" />
