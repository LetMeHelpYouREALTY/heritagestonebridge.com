...
export const metadata: Metadata = buildPageMetadata({
  title: "Summerlin Real Estate | Heritage at Stonebridge 55+ | Dr. Jan Duffy",
  description:
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Summerlin Real Estate Market | January 2026" />
          ...
          {/* FAQ Section */}
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="Frequently Asked Questions About Summerlin Real Estate" />
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Ready to Find Your Summerlin Home?" />
