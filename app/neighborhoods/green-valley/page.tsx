      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Green Valley Real Estate Market | January 2026" />
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              <SectionImage heading="Green Valley: Where Henderson Families Have Thrived for 35+ Years" />
          ...
          {/* FAQ Section */}
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="Frequently Asked Questions About Green Valley Real Estate" />
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Discover Green Valley Living" />
