      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Centennial Hills Market | January 2026" />
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              <SectionImage heading="Centennial Hills: Northwest Las Vegas's Established Family Community" />
              ...
              {/* Schools */}
              <SectionImage
                heading="Centennial Hills School Districts"
                variant="inline"
              />
              <h3 className="text-2xl font-bold text-slate-900 mt-12 mb-6">
              ...
              {/* Commute Times */}
              <SectionImage
                heading="Commute Times from Centennial Hills"
                variant="inline"
              />
              <h3 className="text-2xl font-bold text-slate-900 mt-12 mb-6">
          ...
          {/* FAQ Section */}
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="Frequently Asked Questions About Centennial Hills" />
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Find Your Centennial Hills Home" />
