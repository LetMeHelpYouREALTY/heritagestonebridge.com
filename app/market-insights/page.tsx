    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          {/* Hero */}
          <PageHero
            badge="2026 Economic & Real Estate Analysis"
            title="Las Vegas Market Insights"
            subtitle="In 2026, technology growth, California migration, and economic diversification are reshaping Las Vegas real estate — driving stronger appreciation across Henderson, Summerlin, and the valley's emerging tech corridors."
            priority
          />

          {/* Key Drivers */}
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="5 Forces Driving Las Vegas Real Estate in 2026" />
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="flex items-center mb-6">
              ...
              <SectionImage heading="Las Vegas Tech Transformation" />
          ...
          <section className="mb-16 bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="flex items-center mb-6">
              ...
              <SectionImage heading="California Migration Analysis" />
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="flex items-center mb-6">
              ...
              <SectionImage heading="Economic Diversification" />
              <h2 className="text-3xl font-bold text-slate-900">
                Economic Diversification
              </h2>
            </div>
          ...
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="flex items-center mb-6">
              ...
              <SectionImage heading="2026 Neighborhood Outlook" />
              <h2 className="text-3xl font-bold text-slate-900">
          ...
          {/* What This Means */}
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="What This Means for You" />
          ...
          <section className="text-center bg-purple-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Get Personalized Market Analysis" />
