      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Extract Your Equity, Enjoy Your Life" />
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="Popular Downsizing Destinations" />
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="Top 55+ Communities for Las Vegas Downsizers" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          {/* What to Consider */}
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Key Considerations When Downsizing" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="The Downsizing Process with Dr. Jan Duffy" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          {/* FAQ Section */}
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="Downsizing FAQs" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
              Downsizing FAQs
            </h2>
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Ready to Simplify Your Life?" />
