      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="Situations We Help Navigate" />
          ...
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Our Approach to Sensitive Transactions" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="Nevada-Specific Considerations" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          {/* The Process */}
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="How We Handle Sensitive Transactions" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          {/* Why BHHS Matters */}
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="Why Berkshire Hathaway HomeServices for Sensitive Sales" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="text-center bg-slate-800 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Confidential Consultation" />
