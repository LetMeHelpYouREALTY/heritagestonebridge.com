      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <PageHero
            ...
            subtitle="Berkshire Hathaway HomeServices is the gold standard in luxury real estate. For $1M+ homes, our global network, discretion, and expertise ensure your transaction receives exceptional service."
            priority
          >
            <div className="flex flex-wrap justify-center gap-4 text-sm text-white/80">
              <span className="flex items-center">
                <CheckCircle className="h-4 w-4 text-green-400 mr-1" /> White
                Glove Service
              </span>
              <span className="flex items-center">
                <CheckCircle className="h-4 w-4 text-green-400 mr-1" /> Global
                Buyer Network
              </span>
              <span className="flex items-center">
                <CheckCircle className="h-4 w-4 text-green-400 mr-1" /> Discrete
                Transactions
              </span>
            </div>
          </PageHero>
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Las Vegas Luxury Market Statistics | January 2026" />
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            <SectionImage heading="Why Choose Berkshire Hathaway for Luxury Real Estate" />
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            <SectionImage heading="Premier Las Vegas Luxury Communities" />
            <h2 className="text-3xl font-bold text-slate-900 mb-4 text-center">
          ...
          <section className="mb-16 bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
            <SectionImage heading="Luxury Home Marketing Services" />
            <h2 className="text-2xl font-bold mb-4 text-center">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="Luxury Buyer & Seller Services" />
          ...
          {/* FAQ */}
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="Frequently Asked Questions About Las Vegas Luxury Homes" />
            <h2 className="text-3xl font-bold text-slate-900 mb-4 text-center">
          ...
          <section className="text-center bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Discover Las Vegas Luxury Living" />
