      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <PageHero
            ...
            subtitle="Comprehensive real estate solutions from Dr. Jan Duffy, backed by Berkshire Hathaway HomeServices — buying your first home, selling a luxury estate, or relocating from California."
            priority
          >
            <div className="flex flex-wrap justify-center gap-6 text-sm text-white/85">
          ...
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
            <SectionImage heading="Specialized Real Estate Services" />
            <h2 className="text-3xl font-bold text-slate-900 mb-4 text-center">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="Services for Every Type of Buyer" />
            <h2 className="text-3xl font-bold text-slate-900 mb-4 text-center">
          ...
          {/* Seller Types */}
          <section className="mb-16 max-w-6xl mx-auto">
            <SectionImage heading="Services for Every Type of Seller" />
            <h2 className="text-3xl font-bold text-slate-900 mb-4 text-center">
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="The Berkshire Hathaway HomeServices Difference" />
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="How Our Real Estate Services Work" />
            <h2 className="text-3xl font-bold text-slate-900 mb-4 text-center">
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Ready to Get Started?" />
