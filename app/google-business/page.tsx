      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <section className="max-w-5xl mx-auto mb-16">
            <div className="bg-slate-50 rounded-xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <SectionImage heading="Business Hours" />
          ...
          <section className="max-w-4xl mx-auto mb-16">
            <SectionImage heading="Office Location & Google Business Profile" />
          ...
          <section className="max-w-4xl mx-auto mb-16">
            <SectionImage heading="Google Business Profile Description" />
          ...
          <section className="max-w-4xl mx-auto mb-16">
            <SectionImage heading="About Dr. Jan Duffy" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
              About Dr. Jan Duffy
            </h2>
          ...
          <section className="max-w-5xl mx-auto mb-16">
            <SectionImage heading="Real Estate Services" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="max-w-5xl mx-auto mb-16">
            <SectionImage heading="Service Areas" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
              Service Areas
            </h2>
          ...
          <section className="max-w-4xl mx-auto mb-16">
            <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-8 text-center">
              ...
              <SectionImage heading="Your Review Helps Others Find Quality Service" />
