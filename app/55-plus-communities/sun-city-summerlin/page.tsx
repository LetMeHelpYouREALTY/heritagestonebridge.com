      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 bg-slate-900 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Sun City Summerlin at a Glance" />
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              <SectionImage heading="About Sun City Summerlin" />
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <SectionImage heading="World-Class Amenities" />
          ...
          <section className="mb-16 bg-slate-50 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <SectionImage heading="Sun City Summerlin Neighborhoods" />
          ...
          {/* Why Choose */}
          <section className="mb-16 max-w-4xl mx-auto">
            <SectionImage heading="Why Buyers Choose Sun City Summerlin" />
            <h2 className="text-3xl font-bold text-slate-900 mb-8 text-center">
          ...
          <section className="text-center bg-amber-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <SectionImage heading="Explore Sun City Summerlin" />
